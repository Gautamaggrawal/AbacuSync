...
class CentreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'area', 'is_active', 'cis', 'student_count', 'created_at'
        ]
...
class StudentLevelHistorySerializer(serializers.ModelSerializer):
    ...
    previous_level_name = serializers.CharField(
        source='previous_level.name',
        read_only=True
    )
    new_level_name = serializers.CharField(
        source='new_level.name',
        read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            'uuid', 'student', 'previous_level', 'new_level',
            'changed_by', 'start_date', 'completion_date', 'created_at',
            'student_name', 'previous_level_name', 'new_level_name',
            'changed_by_name'
        ]
