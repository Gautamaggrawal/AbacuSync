...
class IsCentreAdmin(permissions.BasePermission):
    ...
    """
    def has_permission(self, request, view):
        return request.user and hasattr(request.user, 'profile') and request.user.profile.is_centre_admin
...
class IsCentreAdminForCentre(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(obj, 'centre'):
            return request.user.profile.is_centre_admin and request.user.profile.centre == obj.centre
