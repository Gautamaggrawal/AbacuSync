...
```
cd existing_repo
git remote add origin https://gitlab.com/ucmas2/ucmas-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ucmas2/ucmas-backend/-/settings/integrations)
